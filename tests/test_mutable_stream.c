...
Test(TestMutableStream, test_read_be_u8)
{
...
Test(TestMutableStream, test_read_le_u8)
{
...
Test(TestMutableStream, test_read_be_i8)
{
...
Test(TestMutableStream, test_read_le_i8)
{
...
Test(TestMutableStream, test_read_be_u16)
{
...
Test(TestMutableStream, test_read_le_u16)
{
...
Test(TestMutableStream, test_read_be_i16)
{
...
Test(TestMutableStream, test_read_le_i16)
{
...
Test(TestMutableStream, test_read_be_u32)
{
...
Test(TestMutableStream, test_read_le_u32)
{
...
Test(TestMutableStream, test_read_be_i32)
{
...
Test(TestMutableStream, test_read_le_i32)
{
...
Test(TestMutableStream, test_read_be_f32)
{
...
Test(TestMutableStream, test_read_le_f32)
{
...
Test(TestMutableStream, test_read_be_f64)
{
...
Test(TestMutableStream, test_read_le_f64)
{
...
Test(TestMutableStream, test_read_be_u64)
{
...
Test(TestMutableStream, test_read_le_u64)
{
...
Test(TestMutableStream, test_read_be_i64)
{
...
Test(TestMutableStream, test_read_le_i64)
{
...
Test(TestMutableStream, test_read_be_bool1)
{
...
Test(TestMutableStream, test_read_le_bool1)
{
...
Test(TestMutableStream, test_read_be_bool2)
{
...
Test(TestMutableStream, test_read_le_bool2)
{
...
Test(TestMutableStream, test_read_void)
{
    MutableStream s
...
Test(TestMutableStream, test_mut_stream_tell)
{
    MutableStream s
...
Test(TestMutableStream, test_mut_stream_seek)
{
    MutableStream s
        = mut_stream_new(void_payload, sizeof void_payload, STREAM_BIG_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_be_u8)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_BIG_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_le_u8)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_LITTLE_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_be_i8)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_BIG_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_le_i8)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_LITTLE_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_be_u16)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_BIG_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_le_u16)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_LITTLE_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_be_i16)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_BIG_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_le_i16)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_LITTLE_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_be_u32)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_BIG_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_le_u32)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_LITTLE_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_be_i32)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_BIG_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_le_i32)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_LITTLE_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_be_f32)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_BIG_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_le_f32)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_LITTLE_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_be_f64)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_BIG_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_le_f64)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_LITTLE_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_be_u64)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_BIG_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_le_u64)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_LITTLE_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_be_i64)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_BIG_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_le_i64)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_LITTLE_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_le_bool1)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_LITTLE_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_be_bool1)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_BIG_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_le_bool2)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_LITTLE_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_be_bool2)
{
    u8 buf[100];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_BIG_ENDIAN);
...
Test(TestMutableStream, test_mut_stream_write_void)
{
    u8 buf[sizeof void_payload];
    MutableStream s = mut_stream_new(buf, sizeof buf, STREAM_BIG_ENDIAN);
...
Addr mut_stream_read_addr(MutableStream* stream)
{
    Addr res;
...
void mut_stream_write_addr(MutableStream* stream, Addr addr)
{
...
Test(TestMutableStream, test_stream_extend_types)
{
    MutableStream s
        = mut_stream_new(be_addr, sizeof be_addr, STREAM_BIG_ENDIAN);
